...
./src/test/deca/context/invalid/created/testInitVar/AffectIntReadfloat.deca:9:12: Incompatibilité de type lors de l'assignation. Type attendu : int, Type obtenu : Float
