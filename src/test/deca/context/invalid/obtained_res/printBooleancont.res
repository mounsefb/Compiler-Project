...
./src/test/deca/context/invalid/created/testPrint/printBoolean.deca:9:4:  InvalidPrintTypeException: The type provided as an argument to the print function is invalid. Only int, string, or float types are allowed. 
