...
./src/test/deca/context/invalid/created/testOpArith/moduloBoolean.deca:11:8: IncompatibleTypesException: Modulo operation can only be applied to integer types. 
