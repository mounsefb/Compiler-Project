...
./src/test/deca/context/invalid/created/testOpCmp/CmpClassInt.deca:6:7: IncompatibleTypesException: Cannot compare elements with different types. Ensure that the operands have the same type for the comparison operation. 
