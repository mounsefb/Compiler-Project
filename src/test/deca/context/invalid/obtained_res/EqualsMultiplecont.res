...
./src/test/deca/context/invalid/created/testOpCmp/EqualsMultiple.deca:13:17: IncompatibleTypesException: Cannot compare elements with different types. Ensure that the operands have the same type for the comparison operation. 
