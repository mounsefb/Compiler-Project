...
./src/test/deca/context/invalid/created/testInitVar/multipleWrongInit.deca:8:12: Incompatibilité de type lors de l'assignation. Type attendu : int, Type obtenu : Float
