...
./src/test/deca/context/invalid/created/testConvFloat/ConvFloatAffectInit.deca:13:8: Incompatibilité de type lors de l'assignation. Type attendu : int, Type obtenu : float
